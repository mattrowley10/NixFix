  ...
  return (
    <div className="facial-description pl-2 lg:pl-12">
      ...
      <ul className="facial-list-2 text-xl text-center lg:text-2xl ">
        ...
        <li
          id="2"
          className="facial-pricing mt-60 pt-2 sm:pt-0 sm:mt-56 md:mt-32 lg:mt-24 xl:mt-8 2xl:mt-2"
        >
          $70 (60min)
        </li>
        <li
          id="3"
          className="facial-pricing mt-60 sm:mt-64 md:mt-32 lg:mt-32 lg:pt-2 xl:mt-16 2xl:mt-8"
        >
          $90 (60min)
        </li>
        <li
        ...
        <li
          id="6"
          className="facial-pricing mt-60 pt-2 sm:pt-2 sm:mt-52 md:pt-0 md:mt-32 lg:pt-2 xl:mt-16 2xl:mt-8"
        >
          $120 (75min)
        </li>
        <li
          id="7"
          className="facial-pricing mt-52 pt-2 sm:pt-0 sm:mt-48 md:mt-24 lg:pt-2 xl:mt-16 2xl:mt-6"
        >
          $100 (60min)
        </li>
        <li
          id="8"
          className="facial-pricing mt-60 pt-2 sm:pt-0 sm:mt-52 md:mt-20 lg:mt-32 xl:mt-20 2xl:mt-10"
        >
          $130 (75min)
        </li>
        <li
          id="9"
          className=" mt-52 pt-2 sm:pt-0 sm:mt-48  md:mt-36 lg:mt-40 lg:pt-2 xl:mt-24 2xl:mt-16"
        >
          $250
          <br /> 3 for $690
          <br /> 5 for $1100
